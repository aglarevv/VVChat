...
class ChatService {
    public:
        ...
        //文件传输
        void sendFile(const muduo::net::TcpConnectionPtr& conn, json& js, muduo::Timestamp time);
        //获取好友信息
        void getInfo(const muduo::net::TcpConnectionPtr& conn, json& js, muduo::Timestamp time);
        //注册
