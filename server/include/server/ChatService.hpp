...
class ChatService {
    public:
        ...
        //获取好友信息
        void getFriend(const muduo::net::TcpConnectionPtr& conn, json& js, muduo::Timestamp time);
        //获取群组信息
        void getGroup(const muduo::net::TcpConnectionPtr& conn, json& js, muduo::Timestamp time);
        //注册
